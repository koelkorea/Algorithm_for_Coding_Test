...
// [기본적인 방법] : 재귀를 사용한 dfs + 다이나믹 프로그래밍을 통해 최선조 1번부터 모든 노드를 알아내고 난 뒤, 이를 베이스로 재쉬로 거슬러 올라감

// [기본 녀석의 최악의 시간복잡도] : N*M(케이스의 수) (결과적으로 공통조상 찾을떄까지 곧이 곧대로 올라가야하는데, 그냥 세로 1열로 나열되면 N개 다 돌아봐야함)
